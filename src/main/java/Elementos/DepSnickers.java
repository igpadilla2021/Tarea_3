...
public class DepSnickers extends JPanel {
    /**
     * definimos nuestras coordenadas int x e int y para crear el for que se encarga de administrar snickers en el
    ...
    private int cant=24;
    /**
     * el metodo constructor crea los objetos visibles dentro del expendedor que representan a los snickers y define x e y
     */
    public DepSnickers(){
    ...
    /**
     * moverProducto se encarga de mover el producto (snickers) a el lugar para retirar, cambiando el valor de p y
